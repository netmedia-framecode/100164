...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_gis_korlantas']['name_page'])) {
                          if (!empty($_SESSION['project_gis_korlantas']['name_page'])) {
                            echo " - " . $_SESSION['project_gis_korlantas']['name_page'];
                          }
                        } ?>
</title>
